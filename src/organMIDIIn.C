...
void HOR::midievents(int keIN)
{
    ...
    case SND_SEQ_EVENT_PGMCHANGE:
        ...
        if ((midievent->data.control.value > 0) && (midievent->data.control.value < 33))
...
void HOR::Conecta()
{
    ...
    fclose(fp);
    if (strcmp(MID, "Not Connected") != 0)
        conectaaconnect();
};


void HOR::conectaaconnect()
{
    char tempi[128];
